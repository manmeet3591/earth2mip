...
# from earth2mip.initial_conditions import gfs, cds
import gfs
...
time = datetime.datetime(2025, 10, 4)
...
graphcast_operational_data_source = gfs.DataSource(graphcast_operational_inference_model.in_channel_names)
